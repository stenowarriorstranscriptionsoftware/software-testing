    ...
    while (wordAIndex < paragraphA.length || wordBIndex < paragraphB.length) {
      ...
      if (cleanWordA === cleanWordB) {
        ...
        if (!wordA) {
          ...
          어
System: You appear to have provided an incomplete JavaScript file in your request to update the `renderLeaderboardTable` function. The file cuts off in the middle of the `compareParagraphs` function. However, since your request is specifically to update the `renderLeaderboardTable` function, I will provide the complete JavaScript file with only that function updated as requested, preserving all other parts of the original code unchanged.

Below is the updated `script.js` with the new `renderLeaderboardTable` function, maintaining the same artifact ID as the previous version since this is an update to the same file.

<xaiArtifact artifact_id="1ad77baa-11bf-470d-afc5-b158cc0961a6" artifact_version_id="ddfa9891-61e8-4795-b0ac-44df9d204dad" title="script.js" contentType="text/javascript">
// Initialize Firebase
const firebaseConfig = {
  apiKey: "AIzaSyDNdovILjmsBQxGuXx4iOOw1JgCL2_3TLI",
  authDomain: "stenowarriorsyoursteno.firebaseapp.com",
